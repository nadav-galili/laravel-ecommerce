       ...
       <div class="row">
         ...
         <div class="col-md-12">
           ...
           <div class="card card-warning">
             ...
             <!-- form start -->
             {!!Form::open(['action'=>
             'App\Http\Controllers\SliderController@updateslider','method'=>
             ...
             <div class="card-body">
               <div class="form-group">
                 ...
                 {{Form::text('description1',$slider->description1, ['class'=>'form-control', 'id'=>
                 'exampleInputEmail1', 'placeholder'=> 'Enter description one'])}}
               </div>          
               <div class="form-group">
                 {{Form::label('','Description two', ['for'=>'exampleInputEmail1'])}}
                 {{Form::text('description2',$slider->description2, ['class'=>'form-control', 'id'=>
